...
public class ColorUtils {
    ...
    public static boolean isUp1_16(){
        if(getVersion().contains("1_8"))return false;
        if (getVersion().contains("1_9")) return false;
        if (getVersion().contains("1_10")) return false;
        if (getVersion().contains("1_11")) return false;
        if (getVersion().contains("1_12")) return false;
        if (getVersion().contains("1_13")) return false;
        if (getVersion().contains("1_14")) return false;
        if (getVersion().contains("1_15")) return false;
        return true;
    }
